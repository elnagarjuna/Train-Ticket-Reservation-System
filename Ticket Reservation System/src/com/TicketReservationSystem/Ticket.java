...
import com.TicketReservationSystem.Passenger.AllotedBerth;
import com.TicketReservationSystem.Passenger.Berth;
			...
			if(!Administrator.racTicketList.contains(Integer.valueOf(pnrNumber))) {
				...
				if(Administrator.racTicketList.size() > 0) {
					...
					if(Administrator.waitingTicketList.size() > 0) {
						Passenger passengerFromWaitingList = Administrator.passengersList.get(Administrator.waitingTicketList.poll());
