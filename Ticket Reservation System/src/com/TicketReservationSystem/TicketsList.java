...
public class TicketsList {
	...
	public void bookedTicketList() {
		...
		if(Administrator.passengersList.size() > 0) {
			int i = 1;
			System.out.println("Sl.No.\tPNR No.\tName\tAge\tGender\tChild Name\tChild Age\tChild Gender\tAlloted Berth");
	...
	public void availableTicketList() {
		...
		if((Ticket.availableLowerBerth == 0) && (Ticket.availableMiddleBerth == 0) && 
				(Ticket.availableUpperBerth == 0) && (Ticket.availableSideUpperBerth == 0) && 
				(Ticket.availableRACTicket == 0) && (Ticket.availableWaitingTicket == 0)) {
